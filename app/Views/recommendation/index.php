...
<?php /* ============================================================
   "Find My EV" Quiz Page â€“ Charj.in EV Marketplace
   CI4 view Â· Tailwind CSS Â· Alpine.js
...
<div x-data="findMyEv()" x-init="init()" class="min-h-screen bg-gray-50">
    ...
    <!-- â”€â”€ Quiz Container â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
    <div class="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <template x-for="(vehicle, idx) in results" :key="vehicle.id">
                        <div class="result-card bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all"
                            ...
                            <div class="relative">
                                ...
                                <div x-show="!vehicle.image" class="bg-gray-100 h-36 flex items-center justify-center text-5xl">ðŸ”‹</div>
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-[#22C55E] font-bold text-lg mb-3">
                                    â‚¹<span x-text="Number(vehicle.starting_price).toLocaleString('en-IN')"></span>
                                </p>
        ...
        <div x-show="!showResults" class="quiz-enter">
            ...
            <!-- â”€â”€ STEP 1: Use case â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
            <div x-show="currentStep === 1" class="step-card">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid sm:grid-cols-2 gap-3">
                        <?php
                        $useCases = [
                            ['value'=>'personal_commute', 'icon'=>'ðŸ™', 'label'=>'Personal Daily Commute',    'desc'=>'Office or college, daily city travel'],
                            ['value'=>'personal_family',  'icon'=>'ðŸ‘¨â€ðŸ‘©â€ðŸ‘§', 'label'=>'Personal Family Use',       'desc'=>'Weekend trips, school runs, outings'],
                            ['value'=>'business',         'icon'=>'ðŸ’¼', 'label'=>'Business / Commercial',     'desc'=>'Deliveries, cab, business travel'],
                            ['value'=>'fleet',            'icon'=>'ðŸšŒ', 'label'=>'Fleet (5+ vehicles)',        'desc'=>'Corporate fleet, logistics'],
                        ];
            ...
            <!-- â”€â”€ STEP 2: Budget â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
            <div x-show="currentStep === 2" x-cloak class="step-card">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div x-data="{ budgetVal: answers.budgetMax || 500000 }" class="mb-6 bg-gray-50 rounded-2xl p-5">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-xl font-black text-[#0D2137]">
                                â‚¹<span x-text="formatBudget(budgetVal)"></span>
                            </span>
                        </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-6">
                        <?php
                        $budgets = [
                            ['label'=>'Under â‚¹1L',  'max'=>100000,  'value'=>'under_1l'],
                            ['label'=>'â‚¹1â€“2 Lakh',  'max'=>200000,  'value'=>'1_2l'],
                            ['label'=>'â‚¹2â€“5 Lakh',  'max'=>500000,  'value'=>'2_5l'],
                            ['label'=>'â‚¹5â€“15 Lakh', 'max'=>1500000, 'value'=>'5_15l'],
                            ['label'=>'Above â‚¹15L', 'max'=>10000000,'value'=>'above_15l'],
                        ];
            ...
            <!-- â”€â”€ STEP 3: Daily Distance â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
            <div x-show="currentStep === 3" x-cloak class="step-card">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid sm:grid-cols-2 gap-3 mb-6">
                        <?php
                        $distances = [
                            ['value'=>'under_30',  'label'=>'Under 30 km',  'icon'=>'ðŸ˜', 'desc'=>'Short city commute','min_range'=>60],
                            ['value'=>'30_60',     'label'=>'30â€“60 km',     'icon'=>'ðŸ™', 'desc'=>'Medium daily drive','min_range'=>100],
                            ['value'=>'60_100',    'label'=>'60â€“100 km',    'icon'=>'ðŸ›£', 'desc'=>'Long daily commute','min_range'=>150],
                            ['value'=>'above_100', 'label'=>'Above 100 km', 'icon'=>'ðŸŒ', 'desc'=>'Highway / outstation','min_range'=>200],
                        ];
                    ...
                    <div class="flex gap-3">
                        <button @click="prevStep()" class="flex-1 bg-gray-100 text-gray-600 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors text-sm">â† Back</button>
                        <button @click="nextStep()" :disabled="!answers.dailyDistance"
                            ...
                            class="flex-1 py-3 rounded-xl font-bold transition-colors text-sm">Next â†’</button>
                    </div>
                </div>
            </div>

            <!-- â”€â”€ STEP 4: EV Type â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
            <div x-show="currentStep === 4" x-cloak class="step-card">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
                        <?php
                        $evTypes = [
                            ['value'=>'scooter',         'icon'=>'ðŸ›µ', 'label'=>'Electric Scooter', 'desc'=>'City commute, easy parking'],
                            ['value'=>'bike',            'icon'=>'ðŸ', 'label'=>'Electric Bike',    'desc'=>'Speed, sporty, range'],
                            ['value'=>'car',             'icon'=>'ðŸš—', 'label'=>'Electric Car',     'desc'=>'Family, comfort, highway'],
                            ['value'=>'rickshaw_loader', 'icon'=>'ðŸ›º', 'label'=>'Rickshaw/Loader',  'desc'=>'Commercial, last-mile'],
                            ['value'=>'dont_know',       'icon'=>'ðŸ¤”', 'label'=>'Not Sure Yet',     'desc'=>'Show me all options'],
                        ];
            ...
            <!-- â”€â”€ STEP 5: Charging â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
            <div x-show="currentStep === 5" x-cloak class="step-card">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="grid sm:grid-cols-3 gap-3 mb-6">
                        <?php
                        $chargingOptions = [
                            ['value'=>'home',   'icon'=>'ðŸ ', 'label'=>'Home Charging',           'desc'=>'I have a parking spot & can install a charger at home'],
                            ['value'=>'public', 'icon'=>'ðŸ”Œ', 'label'=>'Public Charging Only',     'desc'=>'I rely on public charging stations near home/office'],
                            ['value'=>'both',   'icon'=>'âš¡', 'label'=>'Both Home & Public',       'desc'=>'I have home charging and use public chargers on the go'],
                        ];
            ...
            <!-- â”€â”€ STEP 6: Contact (Optional) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
                    ...
                    <div class="flex items-start gap-3 mb-6">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm">
                                Optional â€” skip if you prefer to see results directly.
                    ...
                    <div class="flex gap-3">
                        ...
                        <button @click="submitQuiz()"
                            ...
                            <template x-if="!loading">
                                <span>ðŸ” Find My Perfect EV</span>
                            </template>
                            <template x-if="loading">
