...
<?php /* ============================================================
   EV Running Cost & EMI Calculator â€“ Charj.in EV Marketplace
    ...
    <div class=”bg-gradient-to-br from-[#022C22] to-[#0A3D2B] text-white py-10 px-4”>
        <div class="max-w-7xl mx-auto">
            <nav class="text-sm mb-3 text-gray-400 flex items-center gap-1">
                ...
                <span>â€º</span>
                <a href="<?= base_url('calculators') ?>" class="hover:text-[#22C55E] transition-colors">Calculators</a>
                <span>â€º</span>
                <span class="text-white">Cost Calculator</span>
            </nav>
            <h1 class="text-3xl md:text-4xl font-extrabold mb-2">EV Cost Calculator</h1>
            <p class="text-gray-300 text-base">Find out how much you save by switching to an electric vehicle</p>
        </div>
    </div>
            ...
            <div class="flex-1 min-w-0">
                ...
                <div x-data="{ activeTab: 'running' }" class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <!-- â”€â”€ TAB 1: Running Cost â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="range" x-model.number="evEfficiency" @input="calc()" min="2" max="10" step="0.5"
                                            class="w-full accent-green-500">
                                        <p class="text-xs text-gray-400 mt-0.5">Indian EV average: 4â€“6 km/kWh</p>
                                    </div>

                                    <!-- Electricity cost -->
                                    <div>
                                        <label class="text-sm font-medium text-gray-700 mb-1.5 block">Electricity Cost (â‚¹/kWh)</label>
                                        <div class="relative">
                                    ...
                                    <!-- Petrol cost -->
                                    <div>
                                        <label class="text-sm font-medium text-gray-700 mb-1.5 block">Petrol Price (â‚¹/litre)</label>
                                        <div class="relative">
                                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-semibold">â‚¹</span>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div class="bg-green-50 border border-green-100 rounded-xl p-4 text-center">
                                            ...
                                            <p class="text-2xl font-black text-[#22C55E]">â‚¹<span x-text="evCostPerKm"></span></p>
                                        </div>
                                        <div class="bg-orange-50 border border-orange-100 rounded-xl p-4 text-center">
                                            ...
                                            <p class="text-2xl font-black text-orange-500">â‚¹<span x-text="petrolCostPerKm"></span></p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="space-y-3">
                                            <div>
                                                <div class="flex justify-between text-xs mb-1">
                                                    <span class="text-green-700 font-medium">âš¡ EV</span>
                                                    <span class="text-green-700 font-bold">â‚¹<span x-text="monthlyEvCost.toLocaleString('en-IN')"></span></span>
                                                </div>
                                            ...
                                            <div>
                                                <div class="flex justify-between text-xs mb-1">
                                                    <span class="text-orange-600 font-medium">â›½ Petrol</span>
                                                    <span class="text-orange-600 font-bold">â‚¹<span x-text="monthlyPetrolCost.toLocaleString('en-IN')"></span></span>
                                                </div>
                                                <div class="bg-gray-100 rounded-full h-5 overflow-hidden">
                                    ...
                                    <div class="bg-[#022C22] rounded-2xl p-5 text-white text-center">
                                        ...
                                        <p class="text-xs text-gray-300 mb-4">vs petrol vehicle</p>
                                        <div class="border-t border-white/10 pt-4">
                                            <p class="text-xs text-gray-400 mb-1">Annual Saving</p>
                                            <p class="text-2xl font-bold text-white">
                                                â‚¹<span x-text="yearlySaving.toLocaleString('en-IN')"></span>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <!-- â”€â”€ TAB 2: EMI Calculator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
                        <div x-show="activeTab === 'emi'"
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        <label class="text-sm font-medium text-gray-700 mb-1.5 block">Vehicle Price (â‚¹)</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label class="text-sm font-medium text-gray-700 mb-1.5 block">Down Payment (â‚¹)</label>
                                        <div class="relative">
                                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-semibold text-sm">â‚¹</span>
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="bg-[#022C22] rounded-2xl p-6 text-white text-center">
                                        ...
                                        <p class="text-xs text-gray-400">for <span x-text="tenure"></span> months @ <span x-text="rate"></span>%</p>
                                    </div>
                                    ...
                                    <div class="bg-white border border-gray-100 rounded-2xl p-5 space-y-3">
                                        ...
                                        <div class="flex justify-between py-2 border-b border-gray-50">
                                            ...
                                            <span class="font-bold text-orange-500">â‚¹<span x-text="totalInterest.toLocaleString('en-IN')"></span></span>
                                        </div>
                                        <div class="flex justify-between py-2 border-b border-gray-50">
                    ...
                    <div class="bg-[#22C55E]/10 border border-[#22C55E]/20 rounded-2xl p-5">
                        ...
                        <ul class="space-y-2 text-sm text-gray-700">
                            <li class="flex items-start gap-2">
                                <span class="text-[#22C55E] font-bold mt-0.5 flex-shrink-0">âœ“</span>
                                FAME II subsidy up to â‚¹1.5 lakh
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-[#22C55E] font-bold mt-0.5 flex-shrink-0">âœ“</span>
