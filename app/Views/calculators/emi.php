...
<div class="min-h-screen" style="background:#F5FFF7">
  ...
  <!-- Hero -->
  <div class="pt-24 pb-16" style="background:linear-gradient(135deg,#022C22 0%,#0A3D2B 100%)">
    <div class="mx-auto max-w-3xl px-4 text-center">
      <span class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-bold mb-5" style="background:rgba(255,255,255,.2);color:#fff">
      ...
      <h1 class="text-2xl sm:text-4xl font-black" style="color:#fff">EV Loan EMI Calculator</h1>
      <p class="mt-3 text-base" style="color:rgba(255,255,255,.75)">Calculate your exact monthly EMI — adjust price, down payment, rate & tenure in real time.</p>
    </div>
  </div>
