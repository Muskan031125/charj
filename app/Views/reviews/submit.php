...
<!-- Hero -->
<div class="pt-20 sm:pt-24 lg:pt-28 pb-6 sm:pb-8 lg:pb-12 px-4" style="background:linear-gradient(135deg,#022C22 0%,#0A3D2B 100%)">
  <div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4">
      ...
      <?php endif; ?>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest mb-1" style="color:rgba(255,255,255,.45)"><?= esc($vehicle['brand_name'] ?? '') ?></p>
        <h1 class="text-xl sm:text-2xl font-black text-white leading-tight">Review the <?= esc($vehicle['name']) ?></h1>
      </div>
    </div>
  </div>
</div>
