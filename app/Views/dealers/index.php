...
<div class="mx-auto max-w-7xl px-4 pb-16">
    ...
    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="flex flex-col rounded-2xl p-5 transition card-hover" style="background:#152b30;border:1px solid rgba(255,255,255,.07)">
            ...
            <p class="mt-3 text-xs leading-relaxed text-slate-300">
                <svg class="mr-1 inline h-3.5 w-3.5 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="mt-3 flex flex-wrap gap-1.5">
                <?php foreach ((array)$dealer['brands'] as $brand): ?>
                    <span class="rounded-full px-2.5 py-0.5 text-xs font-semibold" style="background:rgba(255,255,255,.06);color:#8ba3a3;border:1px solid rgba(255,255,255,.07)">
                        <?= esc($brand) ?>
                    </span>
                <?php endforeach; ?>
            </div>
    ...
    <!-- Add dealership CTA -->
    <div class="mt-12 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 p-8 text-center text-white">
        <h3 class="text-2xl font-black">Are you an EV dealer?</h3>
        <p class="mx-auto mt-2 max-w-md text-slate-300">
