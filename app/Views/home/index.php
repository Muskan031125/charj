...
<section class="relative min-h-screen flex flex-col justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-teal-950 to-teal-950">
  ...
  <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
    <div class="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-teal-500 opacity-[0.06] blur-3xl rounded-full"></div>
    <div class="absolute bottom-0 right-0 w-96 h-96 bg-teal-400 opacity-[0.05] blur-3xl rounded-full"></div>
  </div>

  <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 text-center">

    <!-- Eyebrow badge -->
    <div class="inline-flex items-center gap-2 bg-teal-500/20 border border-teal-500/30 rounded-full px-4 py-2 mb-8 animate-fade-in-up stagger-1">
      <span class="text-sm" aria-hidden="true">&#x26A1;</span>
      <span class="text-teal-300 text-xs font-bold tracking-wider uppercase">India's Dedicated EV Marketplace</span>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
      ...
      <div class="reveal animate-fade-in-up <?= $f['stagger'] ?> rounded-2xl p-6 card-hover" style="background:#152b30;border:1px solid rgba(255,255,255,.06)">
        ...
        <a href="<?= $f['url'] ?>"
           ...
           class="inline-flex items-center gap-1 text-sm font-semibold mt-4 hover:gap-2 transition-all duration-150" style="color:#16c4c4">
...
<section class="py-16 reveal" style="background:#0c1a1d">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <a href="<?= $sc['url'] ?>"
         class="text-xs font-semibold text-slate-400 border border-white/10 rounded-full px-4 py-2 hover:text-cyan-300 hover:border-cyan-500 transition-all duration-150" style="background:rgba(255,255,255,.06)">
        <?= $sc['label'] ?>
      </a>
      <?php endforeach; ?>
    </div>
