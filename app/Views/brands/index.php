...
<!-- HERO -->
<section style="background:linear-gradient(160deg,#F0FFF4 0%,#FFFFFF 50%,#EEFFF3 100%);border-bottom:1px solid rgba(0,230,118,.1)">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-10 sm:pb-14 text-center">
    ...
    <p class="text-base sm:text-lg max-w-2xl mx-auto mb-10" style="color:#475569">
        ...
        <div class="flex items-center justify-center h-28 sm:h-32"
          ...
          <?php if (!empty($brand['logo_url'])): ?>
            <img src="<?= esc($brand['logo_url']) ?>" alt="<?= esc($name) ?> logo"
                 class="h-16 w-auto object-contain transition-transform duration-300 group-hover:scale-110" loading="lazy"
...
<section class="py-14" style="background:linear-gradient(160deg,#E6FFED 0%,#EEFFF3 50%,#F0FFF4 100%);border-top:1px solid rgba(0,230,118,.12)">
  <div class="mx-auto max-w-3xl px-4 text-center">
    <div class="w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-6"
         style="background:rgba(0,230,118,.12);border:1px solid rgba(0,230,118,.25)">
      <svg class="w-6 h-6 fill-current" style="color:#00C060" viewBox="0 0 24 24">
        <path d="M13 2L4.09 12.97H11L10 22L20.91 11.03H14L13 2Z"/>
      </svg>
    </div>
    <h2 class="text-2xl font-black text-slate-900 mb-3">Can't decide which brand to choose?</h2>
    <p class="mb-8 text-base max-w-md mx-auto" style="color:#475569">
      Use our free EV recommendation tool — answer a few questions and get a personalised EV shortlist.
    </p>
    <a href="<?= base_url('find-my-ev') ?>"
       class="inline-flex items-center gap-2 font-bold px-8 py-3.5 rounded-full transition-all duration-200"
