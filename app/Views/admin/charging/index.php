<?php
/**
 * Admin Ã¢â‚¬â€ Charging Stations Index
        ...
        <?php if (empty($stations)): ?>
          <tr>
            <td colspan="9" class="px-5 py-12 text-center text-sm text-slate-400">
              No stations found. <a href="/admin/charging-stations/create" class="text-emerald-500 hover:underline">Add the first station.</a>
            </td>
          </tr>
        <?php else: ?>
          <?php
          ...
          <tr class="hover:bg-slate-50/50 transition-colors">
            ...
            <td class="px-5 py-4">
              <div class="flex items-center justify-end gap-2">
                <a href="/admin/charging-stations/edit/<?= esc($station['id']) ?>"
