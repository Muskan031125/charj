 ...
 */
$meta_title       = $meta_title       ?? 'Contact Charj.in â€” India\'s EV Marketplace';
          ...
          <ul class="space-y-5">
            ...
            <li class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="text-xs text-slate-400 mt-0.5">Monâ€“Sat, 10 AM â€“ 7 PM IST</p>
              </div>
            </li>
            ...
            <li class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-slate-600">Charj.in, 4th Floor, The Startup Hub,<br>Koramangala, Bengaluru â€” 560034,<br>Karnataka, India</p>
              </div>
            </li>
          ...
          <div class="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p class="mt-1 text-sm text-slate-300 leading-relaxed">
                List your EVs or dealership on Charj.in and reach thousands of active EV buyers across India every month â€” completely free to get started.
              </p>
            </div>
          </div>
