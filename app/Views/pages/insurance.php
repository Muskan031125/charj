 ...
 */
$meta_title       = $meta_title       ?? 'EV Insurance in India â€” Compare Plans & Get Free Quotes | Charj.in';
...
<section class="bg-[#0D2137] py-12 md:py-16">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
    ...
    <p class="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
      Electric vehicles have unique insurance needs. Understand the differences, compare top insurers, and get free quotes â€” all in one place.
    </p>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      ...
      <div class="rounded-2xl bg-slate-50 border border-slate-100 p-6">
        ...
        <p class="text-sm text-slate-600 leading-relaxed">
          The battery is the most expensive part of an EV â€” often 40â€“60% of the vehicle cost. Standard insurance may exclude battery degradation, thermal damage or water damage. You need a dedicated <strong>Battery Protection Add-on</strong> to cover this risk.
        </p>
      </div>
      ...
      <div class="rounded-2xl bg-slate-50 border border-slate-100 p-6">
        ...
        <p class="text-sm text-slate-600 leading-relaxed">
          Home chargers and portable charging cables can be damaged by power surges, theft or accidents. Some EV-specific policies now include home charger coverage as a bundled add-on â€” ask your insurer before buying.
        </p>
      </div>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      ...
      <div class="rounded-2xl bg-white border-2 border-slate-200 p-6">
        ...
        <ul class="space-y-3 mb-6">
          ...
          <li class="flex items-start gap-2 text-sm text-slate-600">
            <svg class="h-4 w-4 text-[#22C55E] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
            Property damage up to â‚¹7.5 lakh
          </li>
        ...
        <p class="text-sm font-semibold text-[#0D2137]">Typical Premium: <span class="text-[#22C55E]">â‚¹2,000 â€“ â‚¹5,000/yr</span></p>
      </div>
      ...
      <div class="rounded-2xl bg-[#0D2137] border-2 border-[#22C55E] p-6 relative shadow-xl">
        ...
        <p class="text-sm font-semibold text-slate-300">Typical Premium: <span class="text-[#22C55E]">â‚¹8,000 â€“ â‚¹25,000/yr</span></p>
      </div>
      ...
      <div class="rounded-2xl bg-white border-2 border-[#22C55E]/40 p-6">
        ...
        <p class="text-sm font-semibold text-[#0D2137]">Add-on Cost: <span class="text-[#22C55E]">â‚¹1,500 â€“ â‚¹6,000/yr</span></p>
      </div>
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
      ...
      $tips = [
          [
              ...
              'text' => 'Each claim-free year earns you a No-Claim Bonus (NCB) of up to 50%. Avoid small claims and let your NCB compound â€” it\'s the single biggest discount available.',
          ],
          [
              'num'  => '02',
          ...
          [
              ...
              'text' => 'Never auto-renew without comparing. Online portals often offer 10â€“20% lower premiums than offline agents. Use Charj.in\'s free quote comparison to find the best deal.',
          ],
      ];
      foreach ($tips as $tip):
      ?>
...
<section id="get-quotes" class="py-12 md:py-16 bg-[#0D2137]">
  <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-8">
      <h2 class="text-2xl font-bold text-white md:text-3xl">Get EV Insurance Quotes â€” Free Comparison</h2>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <select id="ins_type" name="insurance_type"
              ...
              <option value="not_sure">Not sure â€” need guidance</option>
            </select>
          </div>
        </div>
...
<div x-show="quoteModal" x-cloak
  ...
  <div @click.outside="quoteModal = false"
    ...
    <div class="flex items-center justify-between mb-5">
      <h3 class="text-lg font-bold text-[#0D2137]">Get Quote â€” <span x-text="selectedInsurer"></span></h3>
