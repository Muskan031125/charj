    ...
    <div class="mx-auto max-w-7xl px-4">
        <div class="max-w-2xl">
            ...
            <p class="mt-3 text-base text-slate-300">
                Everything you need to know about financing your electric vehicle â€” from bank loans and NBFC options
        ...
        <div class="space-y-10 lg:col-span-2">
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 md:p-8">
                ...
                <ul class="mt-5 space-y-3">
                    <?php
                    $benefits = [
                        ['title' => 'Lower interest rates than petrol vehicles', 'desc' => 'Most banks offer EV loans at 0.25â€“0.5% lower interest rates compared to conventional vehicle loans.'],
                        ['title' => 'FAME II subsidy reduces effective purchase price', 'desc' => 'FAME II subsidies of up to â‚¹1.5 lakh for 2-wheelers and â‚¹5 lakh for buses reduce your loan principal.'],
                        ['title' => 'Income tax benefit under Section 80EEB', 'desc' => 'Deduction of up to â‚¹1.5 lakh per year on interest paid on EV loans for individuals.'],
                        ['title' => 'Longer loan tenures reduce monthly EMI', 'desc' => 'EV loans with 5â€“7 year tenures make high-range vehicles affordable at modest monthly outgo.'],
                        ['title' => 'Lower running cost offsets EMI', 'desc' => 'With fuel costs 4â€“6x lower for EVs, the monthly savings often cover a significant portion of your EMI.'],
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 md:p-8">
                ...
                $financeOptions = $financeOptions ?? [
                    ['name'=>'SBI Green Car Loan','type'=>'Bank','rate'=>'8.65% â€“ 9.45%','max_tenure'=>'7 years','note'=>'Lowest rates for government employees. Special EV scheme.'],
                    ['name'=>'HDFC Bank EV Loan','type'=>'Bank','rate'=>'8.80% â€“ 10.50%','max_tenure'=>'7 years','note'=>'Quick approval, doorstep service, no foreclosure charges after 12 months.'],
                    ['name'=>'ICICI Bank','type'=>'Bank','rate'=>'8.75% â€“ 10.25%','max_tenure'=>'7 years','note'=>'Pre-approved offers for existing customers. EV-specific schemes.'],
                    ['name'=>'Tata Capital','type'=>'NBFC','rate'=>'9.25% â€“ 12.00%','max_tenure'=>'5 years','note'=>'Flexible EMI options. Good for used EVs too.'],
                    ['name'=>'Bajaj Finserv','type'=>'NBFC','rate'=>'9.50% â€“ 14.00%','max_tenure'=>'5 years','note'=>'Minimal documentation. Instant approval via app.'],
                    ['name'=>'Axis Bank','type'=>'Bank','rate'=>'9.00% â€“ 11.50%','max_tenure'=>'7 years','note'=>'Competitive rates, wide dealer tie-ups across India.'],
                ];
                ?>
            ...
            <div class="rounded-2xl bg-emerald-50 p-6 ring-1 ring-emerald-200 md:p-8">
                ...
                <div class="mt-5 grid gap-3 sm:grid-cols-2">
                    <?php
                    $fameItems = [
                        ['cat'=>'Electric 2-Wheelers','subsidy'=>'Up to â‚¹22,500','note'=>'On qualifying models. Min 40 km range.'],
                        ['cat'=>'Electric 3-Wheelers','subsidy'=>'Up to â‚¹50,000','note'=>'Commercial and private vehicles.'],
                        ['cat'=>'Electric 4-Wheelers','subsidy'=>'Up to â‚¹1,50,000','note'=>'Mostly fleet/commercial currently.'],
                        ['cat'=>'Electric Buses','subsidy'=>'Up to â‚¹50 lakh','note'=>'State-operated electric city buses.'],
                    ];
                ...
                <div class="mt-5 overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php
                            $stateSubsidies = [
                                ['state'=>'Delhi','s2w'=>'â‚¹5,000/kWh (up to â‚¹30,000)','s4w'=>'â‚¹10,000/kWh (up to â‚¹1.5 lakh)','tax'=>'Exempt'],
                                ['state'=>'Maharashtra','s2w'=>'â‚¹10,000 (â‰¤2-wheeler)','s4w'=>'â‚¹2.5 lakh (for first 1 lakh EVs)','tax'=>'Exempt'],
                                ['state'=>'Gujarat','s2w'=>'â‚¹20,000','s4w'=>'â‚¹1.5 lakh','tax'=>'Exempt'],
                                ['state'=>'Rajasthan','s2w'=>'â‚¹10,000','s4w'=>'â‚¹10,000','tax'=>'100% waiver'],
                                ['state'=>'Karnataka','s2w'=>'â‚¹10,000','s4w'=>'â‚¹1 lakh','tax'=>'Exempt'],
                                ['state'=>'Tamil Nadu','s2w'=>'â‚¹10,000','s4w'=>'â‚¹1 lakh','tax'=>'Exempt'],
                                ['state'=>'Telangana','s2w'=>'â‚¹5,000','s4w'=>'â‚¹60,000','tax'=>'Road tax rebate'],
                                ['state'=>'UP','s2w'=>'â‚¹5,000/kWh','s4w'=>'â‚¹1 lakh','tax'=>'100% waiver'],
                            ];
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 md:p-8" x-data="{
                ...
                <div class="mt-6 grid gap-5 sm:grid-cols-2">
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-slate-700">Vehicle Price (â‚¹)</label>
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-slate-700">Down Payment (â‚¹)</label>
                ...
                <div class="mt-5 grid grid-cols-3 gap-4 rounded-xl bg-emerald-50 p-4 text-center">
                    <div>
                        ...
                        <p class="mt-1 text-xl font-black text-slate-900">â‚¹<span x-text="loanAmt.toLocaleString('en-IN')"></span></p>
                    </div>
                    <div class="border-x border-emerald-200">
                        <p class="text-xs font-semibold text-emerald-700">Monthly EMI</p>
                        <p class="mt-1 text-2xl font-black text-emerald-700">â‚¹<span x-text="emi.toLocaleString('en-IN')"></span></p>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-emerald-700">Total Interest</p>
                        <p class="mt-1 text-xl font-black text-slate-900">â‚¹<span x-text="totalInterest.toLocaleString('en-IN')"></span></p>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl bg-slate-900 p-5 text-white">
                ...
                <p class="mt-2 text-sm text-slate-300">
                    Individual taxpayers can claim deduction of up to <strong class="text-emerald-400">â‚¹1.5 lakh per year</strong>
                    on interest paid on EV loans under Section 80EEB of Income Tax Act.
                </p>
                <p class="mt-3 text-xs text-slate-400">Applicable for loans sanctioned between 1 April 2019 â€“ 31 March 2023. Consult your CA for eligibility.</p>
            </div>
        </div>
